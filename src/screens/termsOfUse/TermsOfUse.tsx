...
export const TermsOfUse = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <AppText baseSize={FontSizes.Large} style={styles.title} accessibilityRole="header">
        Termos e Condições Gerais de Uso do Aplicativo de Auxílio para
        Deficientes Visuais.
      </AppText>

      <AppText baseSize={FontSizes.Normal} style={styles.sectionTitle} accessibilityRole="header">
        1. Do Objeto
      </AppText>
      <AppText baseSize={FontSizes.Small} style={styles.sectionText} accessibilityRole="text">
      ...
      <View style={styles.arrayButton}>
        ...
        >
          <AppText baseSize={FontSizes.Normal} style={styles.ButtonText}>Recusar Termos</AppText>
        </Pressable>
        ...
        <Pressable
          ...
          accessibilityRole="button"
        >
          <AppText baseSize={FontSizes.Normal} style={styles.ButtonText}>Aceitar Termos</AppText>
        </Pressable>
      </View>
    </ScrollView>
  );
